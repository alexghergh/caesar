...
# ) -> CompiledStateGraph:
#     """
#     Agent tasked with planning and coordinating the execution of other agents.
#     """
#
#     base_model = get_llm_client(
#         temperature=temperature,
#         top_p=top_p,
#         top_k=top_k,
...
# ) -> CompiledStateGraph:
#     """
#     Agent tasked with generating kernel code.
#     """
#
#     base_model = _get_llm_client(
#         temperature=temperature,
#         top_p=top_p,
#         top_k=top_k,
#         num_completions=num_completions,
...
#     # TODO this doesn't have to be an agent per-se; can just be an LLM call; it
#     # doesn't have to be a conversation, just a one-shot prompt; the prompt is
#     # generated by the prompt agent
#     # does it help for it to be an agent, i.e. remember past kernels?
...
# ) -> CompiledStateGraph:
#     """
#     Agent tasked with improving the input prompt based on the output of the
#     coding agent.
#     """
#
#     base_model = _get_llm_client(
...
#     # TODO does it have to be an agent? probably can just be an LLM
...
#
#
# def create_compiler_profiler_agent(
#     temperature: float = 0.0,
#     top_p: float = 1.0, # nucleus sampling
#     top_k: int = 50,
#     num_completions: int = 1, # beam search
...
# ) -> CompiledStateGraph:
#     """
#     Agent tasked with running the kernel and giving feedback to improve the
#     next kernel.
#
#     Requires compiler / runtime runner / profiler tools.
#     """
#
#     base_model = _get_llm_client(
#         temperature=temperature,
...
#     )
#
#     # create the langchain coding agent, by appending additional middleware on
#     # top of the base LLM
...
# ) -> CompiledStateGraph:
#     """
#     Agent that aggregates / holds information regarding past kernel generation,
#     as well as other documentation that might be helpful.
#     """
#
#     base_model = _get_llm_client(
#         temperature=temperature,
...
#
#
# def create_hardware_feedback_agent(
#     temperature: float = 0.0,
#     top_p: float = 1.0, # nucleus sampling
#     top_k: int = 50,
#     num_completions: int = 1, # beam search
...
# ) -> CompiledStateGraph:
#     """
#     Agent that looks at the hardware and the kernel code generated and gives
